...
<body>
	<ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/oa/newTecReward/form">新技术引进奖登记</a></li>
		<li><a href="${ctx}/oa/newTecReward/list">所有任务</a></li>
		<li><a href="${ctx}/oa/newTecReward/task">待办任务</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="reward" action="${ctx}/oa/newTecReward/save" method="post"
		...
		<c:if test="${audit eq true}">
			...
			<div class='control-group'>
				<label class='control-label'>奖励部门:</label>
				<div class='controls'>
	...
	<c:if test="${forAudit eq true}">
		<form:form id="checkForm" modelAttribute="rewardToUser" action="${ctx}/oa/newTecReward/saveRewardToUser" method="post"
			class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<a href="${ctx}/oa/newTecReward/get/${reward.id}">${reward.file}</a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">备注：</label>
			...
			<hr>
			<div class="control-group">
				<label class="control-label"><font color='red'>*</font>先进程度：</label>
				<div class="controls">
					<form:input path="one" class="required digits" />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label"><font color='red'>*</font>技术难度：</label>
				<div class="controls">
					<form:input path="two" class="required digits" />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label"><font color='red'>*</font>社会和经济效益：</label>
				<div class="controls">
					<form:input path="three" class="required digits" />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label"><font color='red'>*</font>适用和推广应用价值：</label>
				<div class="controls">
