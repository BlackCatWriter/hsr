...
<body>
	<form:form id="inputForm" modelAttribute="reward" action="${ctx}/cms/reward/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<tags:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">科技进步奖名称:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<a href="${ctx}/cms/reward/get/${reward.id}">${reward.file}</a>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">科技进步奖级别:</label>
			<div class="controls">
				<form:input value="${rewardGrade}" path="rewardGrade" htmlEscape="false" maxlength="200" readonly="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">科技进步奖等级:</label>
			<div class="controls">
