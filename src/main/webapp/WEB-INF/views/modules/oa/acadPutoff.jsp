...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/acad/putoff">学会协会任职延期</a></li> 
		<li><a href="${ctx}/oa/acad/list">所有任务</a></li>
		<li><a href="${ctx}/oa/acad/task">待办任务</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="acad" action="${ctx}/oa/acad/update" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="exerciseRole" >
					<form:options id="exerciseRole" items="${fns:getDictList('acad_exercise_role')}" itemLabel="label" itemValue="value" htmlEscape="false" readonly="true"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="level" >
					<form:options id="level" items="${fns:getDictList('acad_level_type')}" itemLabel="label" itemValue="value" htmlEscape="false" readonly="true"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input id="endDate" path="endDate" type="text" readonly="readonly" class="Wdate required"
