...
<body>
	...
	<br />
	<form:form id="inputForm" modelAttribute="patent" action="${ctx}/oa/patent/save" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="time"  name="time"  type="text" readonly="readonly" maxlength="20" class="input-medium Wdate" style="width:163px;"
					value="${patent.time}" onclick="WdatePicker({dateFmt:'yyyy'});"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			...
			<c:if test="${not empty taskId}">
				<input id="btnReSubmit" class="btn btn-primary" type="button" onclick="repatentSubmit(true)" value="重新申请" />&nbsp;
			<input id="btnRefuseSubmit" class="btn btn-primary" type="button" onclick="repatentSubmit(false)" value="放弃申请" />&nbsp;</c:if>
