...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/user/initPwd">修改密码</a></li>
		<li><a href="${ctx}/sys/user/initInfo">个人信息</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/changePwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>
