...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/advstudy/form">进修申请</a></li>
	...
	<form:form id="inputForm" modelAttribute="advstudy" action="${ctx}/oa/advstudy/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<c:if test="${not empty taskId}">
					已上传文件：<a href="${ctx}/oa/advstudy/get/${advstudy.id}">${advstudy.file}</a></c:if>
		...
		<div class="form-actions">
			...
			<c:if test="${not empty taskId}"><input id="btnReSubmit" class="btn btn-primary" type="button" onclick="readvstudySubmit(true)" value="重新申请"/>&nbsp;
			<input id="btnRefuseSubmit" class="btn btn-primary" type="button" onclick="readvstudySubmit(false)" value="放弃申请"/>&nbsp;</c:if>
