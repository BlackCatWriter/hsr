...
function page(n, s) {
    $("#pageNo").val(n);
    $("#pageSize").val(s);
    $("#searchForm").attr("action", "${ctx}/cms/expense/search");
    $("#searchForm").submit();
    return false;
}
</script>
...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/expense">经费列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="expense" action="${ctx}/cms/expense/search" method="post"
