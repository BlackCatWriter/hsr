...
<head>
	...
	<script type="text/javascript">
		var key, lastValue = "", nodeList = [],i=0;
		var tree, setting = {view:{selectedMulti:false},check:{enable:"${checked}",nocheckInherit:true,chkboxType : {"Y": "ps", "N": "ps"},},
				...
				callback:{beforeCheck:function(id, node){
					if(node.checked==true)
					{
						node.id=node.id.substring(node.id.length-2);
					}else
					{
						++i;
						node.id=i+node.id;
