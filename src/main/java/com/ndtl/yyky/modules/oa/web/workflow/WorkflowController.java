package com.ndtl.yyky.modules.oa.web.workflow;
...
import com.ndtl.yyky.modules.oa.service.workflow.WorkflowProcessDefinitionService;
import com.ndtl.yyky.modules.oa.service.workflow.WorkflowTraceService;
...
public class WorkflowController {
    ...
    public void loadByDeployment(@RequestParam("deploymentId") String deploymentId, @RequestParam("resourceName") String resourceName, HttpServletResponse response) throws Exception {
    ...
    @ResponseBody
    public String assign(@PathVariable("tid") String taskId,@PathVariable("uid") String uId) {
