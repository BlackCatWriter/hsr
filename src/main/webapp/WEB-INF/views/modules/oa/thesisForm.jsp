...
<body>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="oa:thesis:edit">
			<li class="active"><a href="${ctx}/oa/thesis/form">论文登记</a></li>
		</shiro:hasPermission>
		<li><a href="${ctx}/oa/thesis/list">所有任务</a></li>
		<li><a href="${ctx}/oa/thesis/task">待办任务</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="thesis" action="${ctx}/oa/thesis/save" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="mag_name" name="mag_name" type="text" value="" />
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="ybm_fee" name="ybm_fee" type="text" value="" class="number ybm_fee" />
			</div>
		</div>
		...
		<div class="form-actions">
			...
			<c:if test="${not empty taskId}">
				<input id="btnReSubmit" class="btn btn-primary" type="button" onclick="rethesisSubmit(true)" value="重新申请" />&nbsp;
			<input id="btnRefuseSubmit" class="btn btn-primary" type="button" onclick="rethesisSubmit(false)" value="放弃申请" />&nbsp;</c:if>
