...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/acad/form">学会协会任职编辑</a></li>  
		<li><a href="${ctx}/oa/acad/list">所有任务</a></li>
		<li><a href="${ctx}/oa/acad/task">待办任务</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="acad" action="${ctx}/oa/acad/edit" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
					已上传文件：<a href="${ctx}/oa/acad/get/${acad.id}">${acad.file}</a>
