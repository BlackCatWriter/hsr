...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/book/editform">著作编辑</a></li>
		<li><a href="${ctx}/oa/book/list">所有任务</a></li>
		<li><a href="${ctx}/oa/book/task">待办任务</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="book" action="${ctx}/oa/book/edit" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
			...
			<div class="controls">
					已上传文件：<a href="${ctx}/oa/book/get/${book.id}">${book.file}</a>
