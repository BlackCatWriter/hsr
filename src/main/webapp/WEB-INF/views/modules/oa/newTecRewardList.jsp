...
<body>
	...
	<li><a href="${ctx}/oa/newTecReward/form">新技术引进奖登记</a></li>
		<li class="active"><a href="${ctx}/oa/newTecReward/list">所有任务</a></li>
		<li><a href="${ctx}/oa/newTecReward/task">待办任务</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="reward" action="${ctx}/oa/newTecReward/list" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="reward">
			...
			<tr>
				...
				<c:if test="${reward.taskKey eq 'kjDeptAudit'}">
					<td><a href="${ctx}/oa/newTecReward/editform?id=${reward.id}">编辑</a></td>
				</c:if>
