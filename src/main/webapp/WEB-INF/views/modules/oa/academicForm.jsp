...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/academic/form">学术活动登记</a></li>
	...
	<form:form id="inputForm" modelAttribute="academic" action="${ctx}/oa/academic/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			...
			<c:if test="${not empty taskId}"><input id="btnReSubmit" class="btn btn-primary" type="button" onclick="reacademicSubmit(true)" value="重新申请"/>&nbsp;
			<input id="btnRefuseSubmit" class="btn btn-primary" type="button" onclick="reacademicSubmit(false)" value="放弃申请"/>&nbsp;</c:if>
